            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12" id="info">
                   <h2>Member information</h2>
                    ...
                    <?php 
                        $con=mysqli_connect("localhost","root","","myproject");
                        $value="select name,reg.id,contactno,address,email,gender,bloodgroup,batch,fcaebookidname,facebookprofilelink,image from user_login usg, registration reg where 
                        usg.id=reg.id and reg.id='$id'";
