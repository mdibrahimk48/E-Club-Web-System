...
//            valid: 'glyphicon glyphicon-ok',
        ...
        fields: {
            ...
            image: {
                validators: {
                    file: {
                        ...
                        maxSize:30720,   // 2048 * 1024  2097152
            ...
            reasonofjoining:{
                validators:{
                    notEmpty:{
                        message:'Please enter reason of joining.'
                    }
                }
            }
	...
	$(document).ready(function(){
		$("#button").click(function(){
            var reasonofjoining=$('#reasonofjoining').val();
            var image=$('#image').val();
            
            
            if(image==''){
                document.getElementById("imagec").innerHTML="Give your picture."
            }
            else if(reasonofjoining == '' ){
                document.getElementById("reasonofjoiningc").innerHTML="Give reason of joining."
            }else{
					...
					success: function(responseText){
                        if(responseText==1){
                           $("#result").text("Your registration is complete !!");
                            ...
                            $("#result").text("You are already registered !!");
                            ;
                        }else{
