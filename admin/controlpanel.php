...
<!--
                        ...
                        xmlhttp.open("GET",'../xml/regdate.php',false);
                        xmlhttp.send();
                        ...
                        for(i=0;i<x.length;i++){
                           recordid=x[i].getElementsByTagName("recordid")[0].childNodes[0].nodeValue;
                            startdate=x[i].getElementsByTagName("startdate")[0].childNodes[0].nodeValue;
                            enddate=x[i].getElementsByTagName("enddate")[0].childNodes[0].nodeValue;
                            
                            document.write("<div class='alert alert-info'>");
                            document.write ("<center><h4>Curent registration date</h4></center>");
                            document.write ("</div>");
                            ...
                            document.write("<tr>");
                            document.write("<th>");
                            document.write("Registration session");
                            document.write("</th>"); 
                            document.write("<th>");
                            document.write("Starting date");
                            document.write("</th>");
                            document.write("<th>");
                            document.write('End date');
                            document.write("</th>");
                            document.write("<th>");
                            document.write('Edit date');
                            document.write("</th>");
                            document.write("</tr>");
                            
                            document.write("<tr>");
                            document.write("<td>");
                            document.write(recordid);
                            document.write("</td>");
                            document.write("<td>");
                            ...
                            document.write("<form method='post'>");
                                document.write("<input type='hidden'  value="+recordid+" id='recordid'>");
                                document.write("<input type='button' class='btn btn-primary editdate' value='Edit Date' data-toggle='modal' data-target='#view-modal'/>");
                            document.write("</form>");
                            document.write("</td>");
...
-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">Registration session</div>
                        <div class="panel-body">
...
<!--                    <div>-->
            ...
            <div class="panel panel-success">
                <div class="panel-heading"><h4>View registered members session wise</h4></div>
              <div class="panel-body">
                 <?php 
