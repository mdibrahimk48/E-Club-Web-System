             ...
             <h2>Information table</h2>
                    ...
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                         <?php 
                            $regmembers="select name,reg.id,contactno,address,email,gender,bloodgroup,batch,fcaebookidname,facebookprofilelink from user_login usg, registration reg where usg.id=reg.id and usertype='member' and permit='yes'";
